...
#     speak.Speak('Welcome to davinci - How are you doing today')
...
#         speak.Speak("sorry Coukdn't understand")
...
if __name__ == "__main__":
    SentimentAnalysis("I'm doing good today")
...
# if "news" in r3.recognize_google(audio):
...
# if "books" in r3.recognize_google(audio):
